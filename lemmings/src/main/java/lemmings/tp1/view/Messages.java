...
import lemmings.tp1.util.MyStringUtils;
...
//Commands
	...
	public static final String COMMAND_UPDATE_HELP = "   [n]one | \"\": user does not perform any action";
	...
	public static final String COMMAND_HELP_HELP = "   [h]elp: print this help message";
	
	// RESET
	public static final String COMMAND_RESET_NAME = "reset";
	public static final String COMMAND_RESET_SHORTCUT = "r";
	public static final String COMMAND_RESET_DETAILS = "[r]eset";
	public static final String COMMAND_RESET_HELP = "   [r]eset: start a new game";
